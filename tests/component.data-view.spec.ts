...
vi.mock("naive-ui", () => ({
               ...
               ...flattenOptions(props.options as any[]).map((option) =>
                  h(
                     "button",
                     {
                        ...
                        onClick: () => emit("select", option.key, option),
                     },
                     String(option.label ?? ""),
                  ),
               ),
   ...
   NEmpty: defineComponent({
      name: "NEmpty",
      setup: () => () => h("div", { class: "empty-state" }, "empty"),
   }),
...
vi.mock("@phosphor-icons/vue", () => ({
   PhArrowCounterClockwise: defineComponent({
      name: "PhArrowCounterClockwise",
      setup: () => () => h("i"),
   }),
   PhArrowsDownUp: defineComponent({
      name: "PhArrowsDownUp",
      setup: () => () => h("i"),
   }),
   PhFunnel: defineComponent({
      name: "PhFunnel",
      setup: () => () => h("i"),
   }),
   PhSortAscending: defineComponent({
      name: "PhSortAscending",
      setup: () => () => h("i"),
   }),
   PhSortDescending: defineComponent({
