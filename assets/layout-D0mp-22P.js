import{_ as E1}from"./layout.vue_vue_type_script_setup_true_lang-C1Kvuqd2.js";import{d as j,D as w,a5 as N,ae as W1,af as E0,ag as I1,ah as N1,ai as v0,aj as j1,ak as O1,A as U,al as q1,F as C0,am as D1,an as F1,ao as G1,v as V,x as g,ap as U1,aq as n,ar as y,as as z,at as E,au as Y1,av as x0,aw as W0,ax as A0,ay as K1,az as J0,aA as X1,aB as I0,aC as J1,aD as $0,a9 as w0,o as Q0,aa as a0,aE as F,aF as Q1,aG as ee,aH as G,aI as f0,aJ as ae,aK as te,aL as re,aM as oe,aN as ne,aO as le,aP as b0,c as d,g as i,y as J,z as Y,k as c,I as ie,a3 as se,C as de,u as ce,a as ue,aQ as N0,r as fe,ac as e0,b as V0,e as L0,aR as be,w as M,h as S,f as L,R as j0,B as i0,j as Z0,i as X,a1 as O0,aS as p0,l as pe,aT as ve,N as he,aU as ge,aV as me,aW as ye,X as xe,aX as Ae,V as $e,Y as we,M as Ve,aY as Le}from"./index-CHNzro-_.js";import{G as Ze}from"./PhArrowLeft.vue-DUHo7GWt.js";import{_ as He}from"./room-status-tag.vue_vue_type_script_setup_true_lang-B7A0ZlV3.js";import{N as Se}from"./Badge-CaSc8rpg.js";import"./LayoutContent-FCjr7WnH.js";import"./attribute-Cz32yFEB.js";const Me=E0(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[E0("&::-webkit-scrollbar",{width:0,height:0})]),Ce=j({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=N(null);function a(f){!(f.currentTarget.offsetWidth<f.currentTarget.scrollWidth)||f.deltaY===0||(f.currentTarget.scrollLeft+=f.deltaY+f.deltaX,f.preventDefault())}const s=W1();return Me.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:I1,ssr:s}),Object.assign({selfRef:e,handleWheel:a},{scrollTo(...f){var A;(A=e.value)===null||A===void 0||A.scrollTo(...f)}})},render(){return w("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var ke=/\s/;function ze(e){for(var a=e.length;a--&&ke.test(e.charAt(a)););return a}var Te=/^\s+/;function Re(e){return e&&e.slice(0,ze(e)+1).replace(Te,"")}var q0=NaN,_e=/^[-+]0x[0-9a-f]+$/i,Pe=/^0b[01]+$/i,Be=/^0o[0-7]+$/i,Ee=parseInt;function D0(e){if(typeof e=="number")return e;if(N1(e))return q0;if(v0(e)){var a=typeof e.valueOf=="function"?e.valueOf():e;e=v0(a)?a+"":a}if(typeof e!="string")return e===0?e:+e;e=Re(e);var s=Pe.test(e);return s||Be.test(e)?Ee(e.slice(2),s?2:8):_e.test(e)?q0:+e}var H0=function(){return j1.Date.now()},We="Expected a function",Ie=Math.max,Ne=Math.min;function je(e,a,s){var p,f,A,t,l,x,m=0,v=!1,H=!1,W=!0;if(typeof e!="function")throw new TypeError(We);a=D0(a)||0,v0(s)&&(v=!!s.leading,H="maxWait"in s,A=H?Ie(D0(s.maxWait)||0,a):A,W="trailing"in s?!!s.trailing:W);function C(u){var Z=p,Q=f;return p=f=void 0,m=u,t=e.apply(Q,Z),t}function R(u){return m=u,l=setTimeout(_,a),v?C(u):t}function k(u){var Z=u-x,Q=u-m,s0=a-Z;return H?Ne(s0,A-Q):s0}function B(u){var Z=u-x,Q=u-m;return x===void 0||Z>=a||Z<0||H&&Q>=A}function _(){var u=H0();if(B(u))return P(u);l=setTimeout(_,k(u))}function P(u){return l=void 0,W&&p?C(u):(p=f=void 0,t)}function D(){l!==void 0&&clearTimeout(l),m=0,p=x=f=l=void 0}function I(){return l===void 0?t:P(H0())}function h(){var u=H0(),Z=B(u);if(p=arguments,f=this,x=u,Z){if(l===void 0)return R(x);if(H)return clearTimeout(l),l=setTimeout(_,a),C(x)}return l===void 0&&(l=setTimeout(_,a)),t}return h.cancel=D,h.flush=I,h}var Oe="Expected a function";function qe(e,a,s){var p=!0,f=!0;if(typeof e!="function")throw new TypeError(Oe);return v0(s)&&(p="leading"in s?!!s.leading:p,f="trailing"in s?!!s.trailing:f),je(e,a,{leading:p,maxWait:a,trailing:f})}const e1=O1("n-tabs"),De={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},Fe=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},U1(De,["displayDirective"])),h0=j({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Fe,setup(e){const{mergedClsPrefixRef:a,valueRef:s,typeRef:p,closableRef:f,tabStyleRef:A,addTabStyleRef:t,tabClassRef:l,addTabClassRef:x,tabChangeIdRef:m,onBeforeLeaveRef:v,triggerRef:H,handleAdd:W,activateTab:C,handleClose:R}=V(e1);return{trigger:H,mergedClosable:g(()=>{if(e.internalAddable)return!1;const{closable:k}=e;return k===void 0?f.value:k}),style:A,addStyle:t,tabClass:l,addTabClass:x,clsPrefix:a,value:s,type:p,handleClose(k){k.stopPropagation(),!e.disabled&&R(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){W();return}const{name:k}=e,B=++m.id;if(k!==s.value){const{value:_}=v;_?Promise.resolve(_(e.name,s.value)).then(P=>{P&&m.id===B&&C(k)}):C(k)}}}},render(){const{internalAddable:e,clsPrefix:a,name:s,disabled:p,label:f,tab:A,value:t,mergedClosable:l,trigger:x,$slots:{default:m}}=this,v=f??A;return w("div",{class:`${a}-tabs-tab-wrapper`},this.internalLeftPadded?w("div",{class:`${a}-tabs-tab-pad`}):null,w("div",Object.assign({key:s,"data-name":s,"data-disabled":p?!0:void 0},U({class:[`${a}-tabs-tab`,t===s&&`${a}-tabs-tab--active`,p&&`${a}-tabs-tab--disabled`,l&&`${a}-tabs-tab--closable`,e&&`${a}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:x==="click"?this.activateTab:void 0,onMouseenter:x==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),w("span",{class:`${a}-tabs-tab__label`},e?w(C0,null,w("div",{class:`${a}-tabs-tab__height-placeholder`}," "),w(D1,{clsPrefix:a},{default:()=>w(F1,null)})):m?m():typeof v=="object"?v:q1(v??s)),l&&this.type==="card"?w(G1,{clsPrefix:a,class:`${a}-tabs-tab__close`,onClick:this.handleClose,disabled:p}):null))}}),Ge=n("tabs",`
...
`,[y("segment-type",[n("tabs-rail",[z("&.transition-disabled",[n("tabs-capsule",`
 transition: none;
 `)])])]),y("top",[n("tab-pane",`
 ...
 display: flex;
 align-items: center;
 `),E("prefix","padding-right: 16px;"),E("suffix","padding-left: 16px;")]),y("top, bottom",[z(">",[n("tabs-nav",[n("tabs-nav-scroll-wrapper",[z("&::before",`
 top: 0;
 bottom: 0;
 left: 0;
 width: 20px;
